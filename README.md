...
[![NPM Version](https://img.shields.io/npm/v/@xpack-dev-tools/gcc?color=blue)](https://www.npmjs.com/package/@xpack-dev-tools/gcc/)
...
A standalone, cross-platform (Windows, GNU/Linux) binary
distribution of GCC,
...
[project website](https://xpack-dev-tools.github.io/gcc-xpack/).

## Project source

The source code of the current release is available on
GitHub as [xpack-dev-tools/gcc-xpack](https://github.com/xpack-dev-tools/gcc-xpack),
the [v15.2.0-1.1](https://github.com/xpack-dev-tools/gcc-xpack/tree/v15.2.0-1.1) tree.
