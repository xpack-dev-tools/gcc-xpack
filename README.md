...
```console
$ tree -L 2 /Users/ilg/Library/xPacks/@xpack-dev-tools/gcc/11.4.0-1.1/.content/
/Users/ilg/Library/xPacks/@xpack-dev-tools/gcc/11.4.0-1.1/.content/
├── README.md
├── bin
│   ├── c++
│   ├── cpp
...
like `11.4.0-1`. When published as a npm package, the version gets
a fifth number, like `11.4.0-1.1`.

Since adherence of third party packages to semver is not guaranteed,
it is recommended to use semver expressions like `^11.4.0` and `~11.4.0`
with caution, and prefer exact matches, like `11.4.0-1.1`.
