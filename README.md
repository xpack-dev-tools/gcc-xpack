...
[![NPM Version](https://img.shields.io/npm/v/@xpack-dev-tools/gcc?color=green)](https://www.npmjs.com/package/@xpack-dev-tools/gcc/)
...
[project web site](https://xpack-dev-tools.github.io/gcc-xpack/).

## Project source

The source code of the current release is available on
[GitHub tag v14.2.0-2.1 tree](https://github.com/xpack-dev-tools/gcc-xpack/tree/v14.2.0-2.1).
