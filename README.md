...
```console
$ tree -L 2 /Users/ilg/Library/xPacks/@xpack-dev-tools/gcc/12.2.0-3.1/.content/
/Users/ilg/Library/xPacks/@xpack-dev-tools/gcc/12.2.0-3.1/.content/
├── README.md
├── bin
│   ├── c++
│   ├── cpp
...
like `12.2.0-3`. When published as a npm package, the version gets
