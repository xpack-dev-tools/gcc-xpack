...
The version string is an extension to semver, the format looks like `12.2.0-1`.
...
total 247864
-rw-rw-r--  1 1000  1000   94916876 Jul 31 21:23 xpack-gcc-12.2.0-1-linux-x64.tar.gz
-rw-rw-r--  1 1000  1000        101 Jul 31 21:23 xpack-gcc-12.2.0-1-linux-x64.tar.gz.sha
-rw-rw-r--  1 1000  1000  107954359 Jul 31 22:36 xpack-gcc-12.2.0-1-win32-ia32.zip
-rw-rw-r--  1 1000  1000         99 Jul 31 22:36 xpack-gcc-12.2.0-1-win32-ia32.zip.sha
-rw-rw-r--  1 1000  1000  112626193 Jul 31 21:41 xpack-gcc-12.2.0-1-win32-x64.zip
-rw-rw-r--  1 1000  1000         98 Jul 31 21:41 xpack-gcc-12.2.0-1-win32-x64.zip.sha
```
...
$ ls -l ~/Work/gcc-*/deploy
total 158536
-rw-rw-r-- 1 ilg ilg 84148158 Jul 31 20:58 xpack-gcc-12.2.0-1-linux-arm64.tar.gz
-rw-rw-r-- 1 ilg ilg      103 Jul 31 20:58 xpack-gcc-12.2.0-1-linux-arm64.tar.gz.sha
-rw-rw-r-- 1 ilg ilg 78181315 Jul 31 23:26 xpack-gcc-12.2.0-1-linux-arm.tar.gz
-rw-rw-r-- 1 ilg ilg      101 Jul 31 23:26 xpack-gcc-12.2.0-1-linux-arm.tar.gz.sha
```
...
$ ls -l ~/Work/gcc-*/deploy
total 163376
-rw-r--r--  1 ilg  staff  66170610 Jul 31 21:01 xpack-gcc-12.2.0-1-darwin-x64.tar.gz
-rw-r--r--  1 ilg  staff       102 Jul 31 21:01 xpack-gcc-12.2.0-1-darwin-x64.tar.gz.sha
```
...
```console
$ .../xpack-gcc-12.2.0-1/gcc/bin/gcc --version
...
```console
$ tree -L 2 /Users/ilg/Library/xPacks/\@xpack-dev-tools/gcc/12.2.0-1.1/.content/
/Users/ilg/Library/xPacks/@xpack-dev-tools/gcc/12.2.0-1.1/.content/
├── README.md
├── bin
│   ├── c++
│   ├── cpp
...
│   ├── x86_64-apple-darwin21.4.0-gcc-12.2.0
