...
file; the format is `12.3.0-2`. The fourth number is the xPack release number
...
Use the new version, suffixed by `pre`, like `12.3.0-2.1.pre`.
...
total 197480
-rw-r--r--  1 ilg  staff  97066662 Aug 31 15:29 xpack-gcc-12.3.0-2-darwin-x64.tar.gz
-rw-r--r--  1 ilg  staff       103 Aug 31 15:29 xpack-gcc-12.3.0-2-darwin-x64.tar.gz.sha
```
...
total 198336
-rw-r--r--  1 ilg  staff  86137205 Aug 31 15:14 xpack-gcc-12.3.0-2-darwin-arm64.tar.gz
-rw-r--r--  1 ilg  staff       105 Aug 31 15:14 xpack-gcc-12.3.0-2-darwin-arm64.tar.gz.sha
```
...
total 136448
-rw-r--r-- 1 ilg ilg 139714298 Aug 31 12:27 xpack-gcc-12.3.0-2-linux-x64.tar.gz
-rw-r--r-- 1 ilg ilg       102 Aug 31 12:27 xpack-gcc-12.3.0-2-linux-x64.tar.gz.sha
```
...
total 175448
-rw-r--r-- 1 ilg ilg 179649271 Aug 31 12:45 xpack-gcc-12.3.0-2-win32-x64.zip
-rw-r--r-- 1 ilg ilg        99 Aug 31 12:45 xpack-gcc-12.3.0-2-win32-x64.zip.sha
```
...
total 115440
-rw-r--r-- 1 ilg ilg 118200784 Aug 31 13:58 xpack-gcc-12.3.0-2-linux-arm64.tar.gz
-rw-r--r-- 1 ilg ilg       104 Aug 31 13:58 xpack-gcc-12.3.0-2-linux-arm64.tar.gz.sha
```
...
total 95896
-rw-r--r-- 1 ilg ilg 98187885 Aug 31 13:37 xpack-gcc-12.3.0-2-linux-arm.tar.gz
-rw-r--r-- 1 ilg ilg      102 Aug 31 13:37 xpack-gcc-12.3.0-2-linux-arm.tar.gz.sha
```
...
```sh
.../xpack-gcc-12.3.0-2/bin/gcc --version
...
named like **xPack GCC v12.3.0-2** (mind the dash),
...
- commit the `develop` branch of `xpack/web-jekyll` GitHub repo;
  use a message like _xPack GCC v12.3.0-2 released_
- push to GitHub
...
- commit all changes, use a message like
  _package.json: update urls for 12.3.0-2.1 release_ (without _v_)
...
- `npm dist-tag add @xpack-dev-tools/gcc@12.3.0-2.1 latest`
- `npm dist-tag ls @xpack-dev-tools/gcc`

In case the previous version is not functional and needs to be unpublished:

- `npm unpublish @xpack-dev-tools/gcc@12.3.0-2.1`
...
- paste the release name like **xPack GCC v12.3.0-2 released**
