...
```sh
.../xpack-gcc-12.2.0-1/bin/gcc --version
...
named like **xPack GCC v12.2.0-1** (mind the dash),
...
- commit the `develop` branch of `xpack/web-jekyll` GitHub repo;
  use a message like _xPack GCC v12.2.0-1 released_
- push to GitHub
...
- commit all changes, use a message like
  _package.json: update urls for 12.2.0-1.1 release_ (without _v_)
...
- `npm dist-tag add @xpack-dev-tools/gcc@12.2.0-1.1 latest`
- `npm dist-tag ls @xpack-dev-tools/gcc`

In case the previous version is not functional and needs to be unpublished:

- `npm unpublish @xpack-dev-tools/gcc@12.2.0-1.X`
...
- paste the release name like **xPack GCC v12.2.0-1 released**
