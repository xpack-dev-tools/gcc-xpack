...
file; the format is `11.2.0-2`. The fourth number is the xPack release number
...
and fix them; assign them to a milestone (like `11.2.0-2`).
...
- add a new entry like _- v11.2.0-2 prepared_
- commit with a message like _prepare v11.2.0-2_
...
```sh
.../xpack-gcc-11.2.0-2/bin/gcc --version
...
- in `CHANGELOG.md`, add the release date and a message like _- v11.2.0-2 released_
- commit and push the `xpack-develop` branch
- run the xPack action `trigger-workflow-publish-release`

The result is a
[draft pre-release](https://github.com/xpack-dev-tools/gcc-xpack/releases/)
tagged like **v11.2.0-2** (mind the dash in the middle!) and
named like **xPack GCC v11.2.0-2** (mind the dash),
...
- commit the `develop` branch of `xpack/web-jekyll` GitHub repo;
  use a message like **xPack GCC v11.2.0-2 released**
- push to GitHub
...
- commit all changes, use a message like
  `package.json: update urls for 11.2.0-2.3 release` (without `v`)

## Publish on the npmjs.com server

- select the `xpack-develop` branch
- check the latest commits `npm run git-log`
- update `CHANGELOG.md`, add a line like _- v11.2.0-2.3 published on npmjs.com_
- commit with a message like _CHANGELOG: publish npm v11.2.0-2.3_
- `npm pack` and check the content of the archive, which should list
  only the `package.json`, the `README.md`, `LICENSE` and `CHANGELOG.md`;
  possibly adjust `.npmignore`
- `npm version 11.2.0-2.3`; the first 5 numbers are the same as the
...
- `npm dist-tag add @xpack-dev-tools/gcc@11.2.0-2.3 latest`
- `npm dist-tag ls @xpack-dev-tools/gcc`

In case the previous version is not functional and needs to be unpublished:

- `npm unpublish @xpack-dev-tools/gcc@11.2.0-2.X`
...
- paste the release name like **xPack GCC v11.2.0-2 released**
