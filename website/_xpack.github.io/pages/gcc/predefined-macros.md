...
When compiling with GCC 11 on Windows, the following built-in definitions are available:

```console
$ /c/Users/ilg/AppData/Roaming/xPacks/@xpack-dev-tools/gcc/11.2.0-1.3/.content/bin/gcc.exe -E -dM - </dev/null | sort
#define WIN32 1
#define WIN64 1
#define WINNT 1
