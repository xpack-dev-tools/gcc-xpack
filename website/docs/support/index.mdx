...
# How to obtain help for xPack GCC
...
- Review the [GitHub Discussions](https://github.com/xpack-dev-tools/gcc-xpack/discussions) for
similar topics
- Examine the [GitHub Issues](https://github.com/xpack-dev-tools/gcc-xpack/issues)
tracker and the
[GitHub Pull Requests](https://github.com/xpack-dev-tools/gcc-xpack/pulls)
for similar problems.
...
others, please 
utilise the [GitHub Discussions](https://github.com/xpack-dev-tools/gcc-xpack/discussions)
pages.
...
[GitHub Discussions](https://github.com/xpack-dev-tools/gcc-xpack/discussions)** pages.
