...
# How to get help for the xPack GCC
...
similar topics
- Check the [GitHub Issues](https://github.com/xpack-dev-tools/gcc-xpack/issues)
tracker and the
...
others, please 
use the [GitHub Discussions](https://github.com/xpack-dev-tools/gcc-xpack/discussions)
pages.
