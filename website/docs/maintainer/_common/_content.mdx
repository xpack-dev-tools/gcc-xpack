...
(such as **12.5.0-1.1**) with the following expression:
...
- In `CHANGELOG.md`, add the release date and a message
  such as _**\* v12.5.0-1 released**_
...
tagged such as **v12.5.0-1** (mind the dash in the middle!) and
named such as **xPack GCC v12.5.0-1** (mind the dash),
...
- **Commit** all changes with the message
  _**package.json: update URLs for 12.5.0-1.1 release**_
