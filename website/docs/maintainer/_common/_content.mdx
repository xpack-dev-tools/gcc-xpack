...
(such as **14.3.0-1.1**) with the following expression:
...
- In `CHANGELOG.md`, add the release date and a message
  such as _**\* v14.3.0-1 released**_
...
tagged such as **v14.3.0-1** (mind the dash in the middle!) and
named such as **xPack GCC v14.3.0-1** (mind the dash),
...
- **Commit** all changes with the message
  _**package.json: update URLs for 14.3.0-1.1 release**_
