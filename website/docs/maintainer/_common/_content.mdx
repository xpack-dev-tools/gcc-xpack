...
The build scripts run on GNU/Linux.
...
the **[Update the version specific code](http://localhost:3000/gcc-xpack/docs/maintainer/#update-the-version-specific-code)** section.
...
and fix them; assign them to a milestone (like <code>14.2.0-2</code>).
...
- to remove the rest of the dates, change from:
  ...
  *
  ```
- add a new entry like _**\* v14.2.0-2 prepared**_
- **commit** with the message _**prepare v14.2.0-2**_
...
The builds currently run on 2 dedicated machines (x64 GNU/Linux, arm64 GNU/Linux).
...
(like **14.2.0**) with the following expression:
...
sequence, for each platform (Windows, GNU/Linux),
and check the
...
ssh sessions to the build machines (`xbbli`, `ampere`):
...
tagged like **v14.2.0-2** (mind the dash in the middle!) and
named like **xPack GCC v14.2.0-2** (mind the dash),
...
- **commit** with the message _**website: blog post release 14.2.0-2 published**_
...
- **commit** all changes with the message
  _**package.json: update urls for 14.2.0-2.1 release**_

### Publish on the npmjs.com server

- select the `xpack-development` branch
- check the latest commits `xpm run git-log`
- update `CHANGELOG.md`, add a line like _**\* v14.2.0-2.1 published on npmjs.com**_
- **commit** with the message _**CHANGELOG: publish npm v14.2.0-2.1**_
...
- open https://xpack-dev-tools.github.io/gcc-xpack/docs/maintainer/#publish-the-website in a separate window
...
- paste the release name like _**xPack GCC v14.2.0-2 released**_
...
[![NPM Version](https://img.shields.io/npm/v/%40xpack-dev-tools%2Fgcc?color=green)](https://www.npmjs.com/package/@xpack-dev-tools/gcc/)
[![NPM Downloads](https://img.shields.io/npm/dm/%40xpack-dev-tools%2Fgcc)](https://www.npmjs.com/package/@xpack-dev-tools/gcc/)
  - all releases [![NPM Downloads](https://img.shields.io/npm/dt/%40xpack-dev-tools%2Fgcc)](https://www.npmjs.com/package/@xpack-dev-tools/gcc/)
