...
The easiest (and recommended) way to install xPack GCC
...
<CodeBlock language="sh"> {
`xpm install @xpack-dev-tools/gcc@14.2.0-2.1 --verbose
`} </CodeBlock>
...
* add <code>@xpack-dev-tools/gcc</code> to
  `package.json` as a
  development dependency; this associates a specific version of xPack GCC with
...
it is also possible to install xPack GCC only globally in
...
In order to access the xPack GCC binaries installed in
...
<CodeBlock language="sh"> {
`export PATH=$HOME/AppData/Roaming/xPacks/\@pack-dev-tools/gcc/14.2.0-2.1/.content/bin:$PATH
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/Library/xPacks/\@pack-dev-tools/gcc/14.2.0-2.1/.content/bin:$PATH
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/.local/xPacks/@xpack-dev-tools/gcc/14.2.0-2.1/.content/bin:$PATH
`} </CodeBlock>
...
<ul>
<li><code>xpack-gcc-14.2.0-2-win32-x64.zip</code></li>
</ul>
...
example <code>C:\\Users\\ilg\\AppData\\Roaming\\xPacks\\gcc\\xpack-gcc-14.2.0-2</code>.
...
<ul>
<li><code>xpack-gcc-14.2.0-2-darwin-x64.tar.gz</code></li>
<li><code>xpack-gcc-14.2.0-2-darwin-arm64.tar.gz</code></li>
</ul>
...
example <code>/Users/ilg/Library/xPacks/gcc/xpack-gcc-14.2.0-2</code>:

<CodeBlock language="console"> {
`mkdir -p ~/Library/xPacks/gcc
cd ~/Library/xPacks/gcc

tar xvf ~/Downloads/xpack-gcc-14.2.0-2-darwin-x64.tar.gz
chmod -R -w xpack-gcc-14.2.0-2
`} </CodeBlock>
...
<ul>
<li><code>xpack-gcc-14.2.0-2-linux-x64.tar.gz</code></li>
<li><code>xpack-gcc-14.2.0-2-linux-arm64.tar.gz</code></li>
<li><code>xpack-gcc-14.2.0-2-linux-arm.tar.gz</code></li>
</ul>
...
example <code>/home/ilg/.local/xPacks/gcc/xpack-gcc-14.2.0-2</code>:

<CodeBlock language="console"> {
`mkdir -p ~/.local/xPacks/gcc
cd ~/.local/xPacks/gcc

tar xvf ~/Downloads/xpack-gcc-14.2.0-2-linux-x64.tar.gz
chmod -R -w xpack-gcc-14.2.0-2
`} </CodeBlock>
