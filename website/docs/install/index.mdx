...
- <code>xpack-gcc-{customField('xpackVersion')}-win32-x64.zip</code>
...
- <code>xpack-gcc-{customField('xpackVersion')}-darwin-x64.tar.gz</code>- <code>xpack-gcc-{customField('xpackVersion')}-darwin-arm64.tar.gz</code>
...
- <code>xpack-gcc-{customField('xpackVersion')}-linux-x64.tar.gz</code>- <code>xpack-gcc-{customField('xpackVersion')}-linux-arm64.tar.gz</code>- <code>xpack-gcc-{customField('xpackVersion')}-linux-arm.tar.gz</code>
