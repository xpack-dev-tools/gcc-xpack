...
[![npm (scoped)](https://img.shields.io/npm/v/%40xpack-dev-tools%2Fgcc?label=xpm&color=blue)](https://www.npmjs.com/package/@xpack-dev-tools/gcc/)
![GitHub Downloads (all assets, all releases)](https://img.shields.io/github/downloads/xpack-dev-tools/gcc-xpack/total)
[![npm](https://img.shields.io/npm/dm/%40xpack-dev-tools%2Fgcc?label=xpm%20downloads)](https://www.npmjs.com/package/@xpack-dev-tools/gcc/)
...
The command to install the **latest** available version of **gcc** is:
...
<CodeBlock language="sh"> {
`xpm install @xpack-dev-tools/gcc@${customField('releaseVersion')} --verbose
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/AppData/Roaming/xPacks/\@pack-dev-tools/gcc/${customField('xpackVersion')}.${customField('npmSubversion')}/.content/bin:$PATH
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/Library/xPacks/\@pack-dev-tools/gcc/${customField('xpackVersion')}.${customField('npmSubversion')}/.content/bin:$PATH
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/.local/xPacks/@xpack-dev-tools/gcc/${customField('xpackVersion')}.${customField('npmSubversion')}/.content/bin:$PATH
`} </CodeBlock>
...
<ul>
<li><code>xpack-gcc-{customField('xpackVersion')}-win32-x64.zip</code></li>
</ul>
...
example <code>C:\\Users\\ilg\\AppData\\Roaming\\xPacks\\gcc\\xpack-gcc-{customField('xpackVersion')}</code>.
...
<ul>
<li><code>xpack-gcc-{customField('xpackVersion')}-darwin-x64.tar.gz</code></li>
<li><code>xpack-gcc-{customField('xpackVersion')}-darwin-arm64.tar.gz</code></li>
</ul>
...
example <code>/Users/ilg/Library/xPacks/gcc/xpack-gcc-{customField('xpackVersion')}</code>:

<CodeBlock language="console"> {
`mkdir -p ~/Library/xPacks/gcc
cd ~/Library/xPacks/gcc

tar xvf ~/Downloads/xpack-gcc-${customField('xpackVersion')}-darwin-x64.tar.gz
chmod -R -w xpack-gcc-${customField('xpackVersion')}
`} </CodeBlock>
...
<ul>
<li><code>xpack-gcc-{customField('xpackVersion')}-linux-x64.tar.gz</code></li>
<li><code>xpack-gcc-{customField('xpackVersion')}-linux-arm64.tar.gz</code></li>
<li><code>xpack-gcc-{customField('xpackVersion')}-linux-arm.tar.gz</code></li>
</ul>
...
example <code>/home/ilg/.local/xPacks/gcc/xpack-gcc-{customField('xpackVersion')}</code>:

<CodeBlock language="console"> {
`mkdir -p ~/.local/xPacks/gcc
cd ~/.local/xPacks/gcc

tar xvf ~/Downloads/xpack-gcc-${customField('xpackVersion')}-linux-x64.tar.gz
chmod -R -w xpack-gcc-${customField('xpackVersion')}
`} </CodeBlock>
