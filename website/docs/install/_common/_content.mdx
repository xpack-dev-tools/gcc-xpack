...
<CodeBlock language="sh"> {
`export PATH=$HOME/AppData/Roaming/xPacks/xpack-dev-tools/gcc/12.5.0-1.1/.content/bin:$PATH
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/.local/xPacks/xpack-dev-tools/gcc/12.5.0-1.1/.content/bin:$PATH
`} </CodeBlock>
...
<ul>
<li><code>xpack-gcc-12.5.0-1-win32-x64.zip</code></li>
</ul>
...
example <code>C:\\Users\\ilg\\AppData\\Roaming\\xPacks\\gcc\\xpack-gcc-12.5.0-1</code>.
...
<ul>
<li><code>xpack-gcc-12.5.0-1-linux-x64.tar.gz</code></li>
<li><code>xpack-gcc-12.5.0-1-linux-arm64.tar.gz</code></li>
</ul>
...
example <code>/home/ilg/.local/xPacks/gcc/xpack-gcc-12.5.0-1</code>:

<CodeBlock language="console"> {
`mkdir -p ~/.local/xPacks/gcc
cd ~/.local/xPacks/gcc

tar xvf ~/Downloads/xpack-gcc-12.5.0-1-linux-x64.tar.gz
chmod -R -w xpack-gcc-12.5.0-1
`} </CodeBlock>
