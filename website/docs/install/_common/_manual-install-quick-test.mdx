...
`C:\\> %USERPROFILE%\\AppData\\Roaming\\xPacks\\${props.permalinkName}\\xpack-${props.permalinkName}-14.2.0-2\\bin\\${props.programName}.exe --version
...
<CodeBlock language="console"> {
`$ ~/.local/xPacks/${props.permalinkName}/xpack-${props.permalinkName}-14.2.0-2/bin/${props.programName} --version
${props.branding}14.2.0
`} </CodeBlock>
