...
cross-platform (Windows, macOS, GNU/Linux)binary distribution of GCC,
...
[build scripts](https://github.com/xpack-dev-tools/gcc-xpack/tree/xpack/build-assets/scripts).
...
[`gcc-xpack.git/build-assets/scripts`](https://github.com/xpack-dev-tools/gcc-xpack/tree/xpack/build-assets/scripts/)
...
- **Star** the project on [GitHub](https://github.com/xpack-dev-tools/gcc-xpack/): It helps others discover our work.
