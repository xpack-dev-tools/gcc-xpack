...
**xPack GCC** is a standalone cross-platform (Windows, macOS, GNU/Linux)
binary distribution of GCC,
intended for reproducible builds.

<Overview/>

**xPack GCC** is an open source project hosted on GitHub as
...
[build scripts](https://github.com/xpack-dev-tools/gcc-xpack/tree/xpack/scripts).
