...
* 75710d8 package.json: update URLs for 15.2.0-1.1 release
* 38b78c0 website: blog post release 15.2.0-1.1 published
* 9ed973c CHANGELOG update
* v15.2.0-1 released
...
* b9f4405 CHANGELOG update
* v14.3.0-1 released
* bd8f6bd website: update folder hierarchies
* 2895a66 website: update actions durations
* 578fe14 website update
* 3f0c2ea prepare v14.3.0-1
* v14.3.0-1 prepared
* e8c2f63 website: add test results
* aeddd0e 13.4.0-1.1
* 4dfe10a package.json .pre
* 8c8e039 CHANGELOG: publish npm v13.4.0-1.1
...
* 8747aad website: blog post release 12.5.0-1.1 published
* 2d88e22 CHANGELOG update
* v12.5.0-1 released
...
* 7a09850 prepare v12.4.0-2
* 5d4283e website: add tests results
* 88b1b61 13.3.0-2.1
* 081333f CHANGELOG: publish npm v13.3.0-2.1
...
* 23cf63e re-generate workflows
* 6d7dd0e move to build-assets

## 2024-08-06

* 4edf5c2 package.json: bump deps

## 2024-08-04

* 25cbd65 package.json: bump deps
* 32173ac package.json: update generate-workflows
* 86afdba templates/jekyll update
* dd2ab04 READMEs update
* 2cd433b package.json: add actions, bump deps

## 2024-07-27

* 57217c9 package.json: add actions, bump deps
* 7ae2d9e templates/jekyll update

## 2024-07-23

* 937009e READMEs update
* 134d1fc move patches to helper
* 792663e package.json: bump deps

## 2024-07-22

* 5d51dbf return to 14.1.0
* 8208083 11.5.0-1.1
* 327716b CHANGELOG: publish npm v11.5.0-1.1
